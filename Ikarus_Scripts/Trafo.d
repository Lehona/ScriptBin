...
NOTIZ: Alle diese Funktionen besitzen jeweils noch ein Abbild f?r X, Y und Z einzelnd. Die Entsprechende Achse muss nur an den Funktionsnamen gehdngt werden. (TRF_MoveToX zB.)
...
(f)int TRF_ArcSin(int sin)
  ...
  (Funktioniert noch nicht ordnungsgemd?, also lieber obere Funktion benutzen)
  R?ckgabewert ist im Bogenma?

(f)int TRF_GetDist(zCVob obj1, zCVob obj2)
  Die Distanz zweier Objekte. Hierbei wird im Gegensatz zu Npc_GetDistToNpc die Hfhe mit einbezogen.
